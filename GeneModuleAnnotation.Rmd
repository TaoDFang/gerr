...
human_go_ontology=data("human_go_ontology.rds", package = "GENEMABR")
human_reactome_ontology=data("human_reactome_ontology.rds", package = "GENEMABR")
gene_pathway_matrix=data("gene_pathway_matrix.rds", package = "GENEMABR")
human_go_roots=data("human_go_roots.rds", package = "GENEMABR")
human_go_sub_roots=data("human_go_sub_roots.rds", package = "GENEMABR")
human_reactome_roots=data("human_reactome_roots.rds", package = "GENEMABR")
...
## use_data(human_go_ontology,human_reactome_ontology,gene_pathway_matrix,human_go_roots,human_go_sub_roots,human_reactome_roots,overwrite = TRUE)

## then document data  in data.R files

## [David 05.05]: it's possible to use data by some twists. See my commitsa and comments. My question is whether such data should be accessible to the users? If yes, data() is a good solution; if not, 'R/sysdata.rda' can be used (see http://r-pkgs.had.co.nz/data.html)
...
#### so we finnlay decided to store .rds format file in data/ folder and use it in this way: data("gene_pathway_matrix.rds", package = "GENEMABR"))
