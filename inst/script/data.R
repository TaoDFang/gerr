...
#'@usage readRDS(system.file("extdata", "human_go_ontology.rds", package = "GENEMABR"))
...
#'@usage  readRDS(system.file("extdata", "human_go_roots.rds", package = "GENEMABR"))
...
#'@usage readRDS(system.file("extdata", "human_go_sub_roots.rds", package = "GENEMABR"))
...
#'@usage readRDS(system.file("extdata", "human_reactome_ontology.rds", package = "GENEMABR"))
#'@format Directed igraph format
...
#'@usage readRDS(system.file("extdata", "human_reactome_roots.rds", package = "GENEMABR"))
...
#'@usage readRDS(system.file("extdata", "gene_pathway_matrix.rds", package = "GENEMABR"))
