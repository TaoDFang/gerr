...
date:"4/27/2019"
output:BioStyle::html_document
vignette:>
    %\VignetteIndexEntry(GENEMABR)
...
To see the latest updates and releases or to post a bug, see our GitHub page at (?). To ask questions about running celda, post a thread on Bioconductor support site at (?).
...
Users could use default gene_pathway_matrix("default") so it will use pre-collected gene_pathway_matrix from GO Ontology and REACTOME databaase.Altertatively, they could use their own customized gene_pathway_matrix 
```{r}
