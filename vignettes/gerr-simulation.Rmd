...
if(params$fullSimulation) {
  ...
  colnames(fullProbSimResDf)[1:3] <- c("p_gs", "p_g", "p_n")
  save(fullProbSimResDf, file="./fullProbSim.RData")
}
```
...
```{r tprGerr}
ggplot(fullProbSimResDf, aes(x=factor(p_gs), y=factor(p_g), fill=TPR.gerr)) +
  facet_wrap(~p_n) +
  geom_tile() +
  scale_fill_gradient2(low="#56B1F7", mid="#999999", high="#AA3555", midpoint=0.5) +
  theme(axis.text.x = element_text(angle=45, hjust=1)) +
  ggtitle("True positive rate of gerr")
```

```{r tprFF}
ggplot(fullProbSimResDf, aes(x=factor(p_gs), y=factor(p_g), fill=TPR.ff)) +
  facet_wrap(~p_n) +
  geom_tile() +
  scale_fill_gradient2(low="#56B1F7", mid="#999999", high="#AA3555", midpoint=0.5) +
  theme(axis.text.x = element_text(angle=45, hjust=1)) +
...
```{r tprGerrVsFF}
ggplot(fullProbSimResDf, aes(x=factor(p_gs), y=factor(p_g), fill=TPR.gerr-TPR.ff)) +
  facet_wrap(~p_n) +
  geom_tile() +
  scale_fill_gradient2(low="yellow", mid="#999999", high="red", midpoint=0) +
  theme(axis.text.x = element_text(angle=45, hjust=1)) +
  ggtitle("True positive rate difference (gerr - FET+FDR)")
```

```{r f1Gerr}
ggplot(fullProbSimResDf, aes(x=factor(p_gs), y=factor(p_g), fill=F1.gerr)) +
  facet_wrap(~p_n) +
  geom_tile() +
  scale_fill_gradient2(low="#56B1F7", mid="#999999", high="#AA3555", midpoint=0.5) +
  theme(axis.text.x = element_text(angle=45, hjust=1)) +
...
```{r fprGerr}
ggplot(fullProbSimResDf, aes(x=factor(p_gs), y=factor(p_g), fill=FPR.gerr)) +
  facet_wrap(~p_n) +
  geom_tile() +
  scale_fill_gradient2(low="#56B1F7", mid="#999999", high="#AA3555") +
  theme(axis.text.x = element_text(angle=45, hjust=1)) +
  ggtitle("False positive rate of gerr")
```

```{r fprFF}
ggplot(fullProbSimResDf, aes(x=factor(p_gs), y=factor(p_g), fill=FPR.ff)) +
  facet_wrap(~p_n) +
  geom_tile() +
  scale_fill_gradient2(low="#56B1F7", mid="#999999", high="#AA3555") +
  theme(axis.text.x = element_text(angle=45, hjust=1)) +
...
```{r fprDiff}
ggplot(fullProbSimResDf, aes(x=factor(p_gs), y=factor(p_g), fill=FPR.gerr - FPR.ff)) +
  facet_wrap(~p_n) +
  geom_tile() +
  scale_fill_gradient2(low="yellow", mid="#999999", high="red") +
  theme(axis.text.x = element_text(angle=45, hjust=1)) +
  ggtitle("False positive rate difference: gerr - FET+FDR")
```

### F1 score

```{r f1FF}
ggplot(fullProbSimResDf, aes(x=factor(p_gs), y=factor(p_g), fill=F1.ff)) +
  facet_wrap(~p_n) +
  geom_tile() +
  scale_fill_gradient2(low="#56B1F7", mid="#999999", high="#AA3555", midpoint=0.5) +
  theme(axis.text.x = element_text(angle=45, hjust=1)) +
...
```{r f1Diff}
ggplot(fullProbSimResDf, aes(x=factor(p_gs), y=factor(p_g), fill=F1.gerr - F1.ff)) +
  facet_wrap(~p_n) +
  geom_tile() +
  scale_fill_gradient2(low="yellow", mid="#999999", high="red", midpoint=0) +
  theme(axis.text.x = element_text(angle=45, hjust=1)) +
...
```{r}
ggplot(fullProbSimResDf, aes(x=factor(p_gs), y=factor(p_g), fill=medTpFpMaxOe.gerr)) +
  facet_wrap(~p_n) +
  geom_tile() +
  scale_fill_gradient2(low="black", mid="#999999", high="yellow2") +
  theme(axis.text.x = element_text(angle=45, hjust=1)) +
